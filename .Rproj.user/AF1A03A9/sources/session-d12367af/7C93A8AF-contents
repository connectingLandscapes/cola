...
## Initials ---
{
  ...
  sh_object <- paste0(gitPath, '/R/showcase.RData')
  ...
  sidebar = 
    dashboardSidebar(
      sidebarMenu(
        ...
        menuItem("PDF", tabName = "tab_pdf", icon = icon("code-fork")),
      ...
      tabItems(
        ...
        tabItem('tab_surface',
                fluidRow(
                  ...
                  column(6, verbatimTextOutput("vout_h2r") , # %>% withSpinner(color="#0dc5c1")
        ...
        tabItem('tab_edit',
                fluidRow(
                  ...
                  column(8, verbatimTextOutput("vout_edi") , # %>% withSpinner(color="#0dc5c1")
        ...
        tabItem('tab_points',
                fluidRow(
                  ...
                  column(8, verbatimTextOutput("vout_points") , # %>% withSpinner(color="#0dc5c1")
        ...
        tabItem('tab_distance',
                fluidRow(
                  ...
                  column(8, verbatimTextOutput("vout_dist") , # %>% withSpinner(color="#0dc5c1")
        ...
        tabItem('tab_corridors',
                fluidRow(
                  ...
                  column(8, verbatimTextOutput("vout_lcc") , # %>% withSpinner(color="#0dc5c1")
        ...
        tabItem('tab_kernels',
                fluidRow(
                  ...
                  column(8, verbatimTextOutput("vout_crk") , # %>% withSpinner(color="#0dc5c1")
        ...
        tabItem('tab_priori',
                fluidRow(
                  ...
                  column(8, verbatimTextOutput("vout_pri") , # %>% withSpinner(color="#0dc5c1")
...
server <- function(input, output, session) {
  ...
  output$pdfviewer <- renderText({
    ...
    return('<iframe style="height:600px; width:100%" src="pdf_logoA.pdf"></iframe>')
      ...
      if(length(outputsRaster) > 0){
        for(i in 1:length(outputsRaster)){ # i = 1
          ...
          if(class(rast2ll) == 'RasterLayer'){
            ...
            r_pal <- colorNumeric(palette = sample(c('viridis', '
                                                     magma', 
                                                     'inferno',  'plasma'), 1), 
                                  reverse = TRUE,
                                  domain = range(rast2ll[], na.rm = TRUE) + 0.0,
