...
if streamlit_authenticator.check_password():
    ...
    def run_cdpop(input_file_path, output_folder):
        ...
        os.chdir(os.path.join(os.path.dirname(__file__), "..", "lib", "CDPOP", "src"))
    ...
    def main():       
        ...
        # Save the uploaded file to disk
            input_path = os.path.join(os.path.dirname(__file__), "..", "lib", "CDPOP", "data", input_file.name)
        ...
        if 'input_df' in st.session_state:
            ...
            #     # Join the parts together with ' > ', and only take the parts after the 'lib' directory
            #     pretty_path = ' > '.join(parts[parts.index('lib'):])
            #     return pretty_path
                    
            if st.sidebar.button("List Output Files"):
                # Parent directory
                data_dir = os.path.join(os.path.dirname(__file__), "..", "lib", "CDPOP", "data")
